...
function StatsSection() {
  return (
    <section className="p-6 md:px-20 md:py-16 md:my-10 bg-no-repeat object-fill w-full bg-gray-100" style={{backgroundSize:'100%',backgroundImage: `url('/assets/banner.png')`}}>
      <div className="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-8">
        <div className="text-black p-6 rounded-lg text-center border border-gray-300 bg-white h-full flex flex-col justify-center min-h-[200px] min-w-[250px] flex-1">
